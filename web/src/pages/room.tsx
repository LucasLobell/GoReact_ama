...
export function Room() {
  ...
  return (
    <div className="mx-auto max-w-[640px] flex flex-col gap-6 py-10 px-6">
      <div className="flex items-center gap-3 px-3">
        ...
        <button type='submit' onClick={handleShareRoom} className='ml-auto bg-zinc-800 text-zinc-300 px-3 py-1.5 gap-1.5 flex items-center rounded-lg font-medium text-sm transition-colors hover:bg-zinc-700'>
          Compartilhar
